                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        {/* <div className="flex justify-between text-[10px] mt-2">
                                            <span className="font-medium text-foreground/80">Max FAR</span>
                                            <Input
                                                type="number"
                                                step="0.1"
                                                value={maxAllowedFAR}
                                                onChange={(e) => setMaxAllowedFAR(Number(e.target.value))}
                                                className="h-6 w-16 text-[10px] bg-muted/20 border-border p-1"
                                            />
                                        </div> */}
                                    </div>
                                </div>
